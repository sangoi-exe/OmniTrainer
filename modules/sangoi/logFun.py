...
def logFun(mensagem, lvl="INFO"):
    ...
    # Nota: Como usamos colorama.init(autoreset=True), não precisamos
    # adicionar Style.RESET_ALL no final de cada print. O colorama faz isso.
    # Se autoreset=False, você precisaria fazer:
    # print(f"{Fore.RED}[ERROR] {mensagem}{Style.RESET_ALL}")
...
class WuerstchenLoRASetup(
    ...
    def create_parameters(
        ...
        self._create_model_part_parameters(
            parameter_group_collection, "prior_text_encoder_lora", model.prior_text_encoder_lora, config.text_encoder
        )
        ...
        self._create_model_part_parameters(
            parameter_group_collection, "prior_prior_lora", model.prior_prior_lora, config.prior
        )
    ...
    def __setup_requires_grad(
        ...
        self._setup_model_part_requires_grad(
            "prior_text_encoder_lora", model.prior_text_encoder_lora, config.text_encoder, model.train_progress
        )
        self._setup_model_part_requires_grad(
            "prior_prior_lora", model.prior_prior_lora, config.prior, model.train_progress
        )
    ...
    def setup_model(
        ...
        model.prior_text_encoder_lora = (
            LoRAModuleWrapper(model.prior_text_encoder, "lora_prior_te", config) if create_te else None
        )

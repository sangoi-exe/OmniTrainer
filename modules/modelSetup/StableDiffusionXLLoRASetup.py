    ...
    def setup_model(
        ...
        if config.train_gps_save_it or config.train_gps_use_it:
            ...
            model.train_gps = TrainGPS(
                ...
                penalty_metric=config.train_gps_penalty_metric,
            )
...
factory.register(
    BaseModelSetup, StableDiffusionXLLoRASetup, ModelType.STABLE_DIFFUSION_XL_10_BASE_INPAINTING, TrainingMethod.LORA
)

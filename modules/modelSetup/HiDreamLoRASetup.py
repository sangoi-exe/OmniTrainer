...
class HiDreamLoRASetup(
    ...
    def create_parameters(
        ...
        self._create_model_part_parameters(
            parameter_group_collection, "text_encoder_3_lora", model.text_encoder_3_lora, config.text_encoder_3
        )
        self._create_model_part_parameters(
            parameter_group_collection, "text_encoder_4_lora", model.text_encoder_4_lora, config.text_encoder_4
        )
    ...
    def __setup_requires_grad(
        ...
        self._setup_model_part_requires_grad(
            "text_encoder_3_lora", model.text_encoder_3_lora, config.text_encoder_3, model.train_progress
        )
        self._setup_model_part_requires_grad(
            "text_encoder_4_lora", model.text_encoder_4_lora, config.text_encoder_4, model.train_progress
        )
        self._setup_model_part_requires_grad(
    ...
    def setup_model(
        ...
        if model.text_encoder_3 is not None:
            model.text_encoder_3_lora = (
                LoRAModuleWrapper(model.text_encoder_3, "lora_te3", config) if create_te3 else None
            )

        if model.text_encoder_4 is not None:
            model.text_encoder_4_lora = (
                LoRAModuleWrapper(model.text_encoder_4, "lora_te4", config) if create_te4 else None
            )
    ...
    def setup_train_device(
        ...
        text_encoder_3_on_train_device = config.train_text_encoder_3_or_embedding() or not config.latent_caching

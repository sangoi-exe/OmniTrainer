...
class CloudTab:
    def __init__(self, master, train_config: TrainConfig, ui_state: UIState, parent):
        ...
        components.label(
            ...
            2,
            "Install OneTrainer",
            tooltip="Automatically install OneTrainer if the directory doesn't already exist.",
        )
        ...
        components.label(
            ...
            2,
            "Install command",
            tooltip="The command for installing this OneTrainer source on the cloud. Required when automatic install is enabled.",
        )

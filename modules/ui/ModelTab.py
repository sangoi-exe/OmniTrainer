...
class ModelTab:
    ...
    def __setup_stable_diffusion_ui(self, frame):
        ...
        row = self.__create_output_components(
            ...
            allow_diffusers=self.train_config.training_method
            in [
    ...
    def __create_dtype_options(
        self, include_gguf: bool = False, include_a8: bool = False
    ...
    def __create_base_components(
        ...
        if has_unet:
            # unet weight dtype
            components.label(frame, row, 3, "UNet Data Type", tooltip="The unet weight data type")
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(include_a8=True), self.ui_state, "unet.weight_dtype"
            )
        ...
        if has_prior:
            ...
            # prior weight dtype
            components.label(frame, row, 3, "Prior Data Type", tooltip="The prior weight data type")
            components.options_kv(frame, row, 4, self.__create_dtype_options(), self.ui_state, "prior.weight_dtype")
        ...
        if has_transformer:
            ...
            components.label(frame, row, 3, "Transformer Data Type", tooltip="The transformer weight data type")
            components.options_kv(
                frame,
                row,
                4,
        ...
        components.layer_filter_entry(
            ...
            1,
            self.ui_state,
            preset_var_name="quantization.layer_filter_preset",
            presets=presets,
        ...
        components.label(
            svd_label_frame, 0, 0, "SVDQuant", tooltip="What datatype to use for SVDQuant weights decomposition."
        )
        components.options_kv(
            svd_entry_frame,
            0,
            0,
            [("disabled", DataType.NONE), ("float32", DataType.FLOAT_32), ("bfloat16", DataType.BFLOAT_16)],
            self.ui_state,
            "quantization.svd_dtype",
        )
        components.label(svd_label_frame, 1, 0, "SVDQuant Rank", tooltip="Rank for SVDQuant weights decomposition")
        ...
        if has_text_encoder:
            ...
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "text_encoder.weight_dtype"
            )
        ...
        if has_text_encoder_1:
            ...
            components.label(frame, row, 3, "Text Encoder 1 Data Type", tooltip="The text encoder 1 weight data type")
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "text_encoder.weight_dtype"
            )
        ...
        if has_text_encoder_2:
            ...
            components.label(frame, row, 3, "Text Encoder 2 Data Type", tooltip="The text encoder 2 weight data type")
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "text_encoder_2.weight_dtype"
            )
        ...
        if has_text_encoder_3:
            ...
            components.label(frame, row, 3, "Text Encoder 3 Data Type", tooltip="The text encoder 3 weight data type")
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "text_encoder_3.weight_dtype"
            )
        ...
        if has_text_encoder_4:
            ...
            # text encoder 4 weight dtype
            components.label(frame, row, 3, "Text Encoder 4 Data Type", tooltip="The text encoder 4 weight data type")
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "text_encoder_4.weight_dtype"
            )
        ...
        if has_vae:
            ...
            # vae weight dtype
            components.label(frame, row, 3, "VAE Data Type", tooltip="The vae weight data type")
            components.options_kv(frame, row, 4, self.__create_dtype_options(), self.ui_state, "vae.weight_dtype")
    ...
    def __create_effnet_encoder_components(self, frame, row: int):
        ...
        components.label(frame, row, 3, "Effnet Encoder Data Type", tooltip="The effnet encoder weight data type")
        components.options_kv(
            frame, row, 4, self.__create_dtype_options(), self.ui_state, "effnet_encoder.weight_dtype"
        )
    ...
    def __create_decoder_components(
        ...
        components.path_entry(
            frame, row, 1, self.ui_state, "decoder.model_name", mode="file", path_modifier=components.json_path_modifier
        )

        # decoder weight dtype
        components.label(frame, row, 3, "Decoder Data Type", tooltip="The decoder weight data type")
        components.options_kv(frame, row, 4, self.__create_dtype_options(), self.ui_state, "decoder.weight_dtype")
        ...
        if has_text_encoder:
            ...
            components.label(
                frame, row, 3, "Decoder Text Encoder Data Type", tooltip="The decoder text encoder weight data type"
            )
            components.options_kv(
                frame, row, 4, self.__create_dtype_options(), self.ui_state, "decoder_text_encoder.weight_dtype"
            )

            row += 1

        # decoder vqgan weight dtype
        components.label(frame, row, 3, "Decoder VQGAN Data Type", tooltip="The decoder vqgan weight data type")
        components.options_kv(frame, row, 4, self.__create_dtype_options(), self.ui_state, "decoder_vqgan.weight_dtype")
    ...
    def __create_output_components(
        ...
        components.label(
            frame, row, 0, "Model Output Destination", tooltip="Filename or directory where the output model is saved"
        )
        components.path_entry(
            frame,
            row,
        ...
        # output data type
        components.label(frame, row, 3, "Output Data Type", tooltip="Precision to use when saving the output model")
        components.options_kv(
            frame,
            row,
            4,
        ...
        components.label(frame, row, 0, "Output Format", tooltip="Format to use when saving the output model")

...
class TrainUI(ctk.CTk):
    ...
    def bottom_bar(self, master):
        ...
        self.pause_switch_widget = ctk.CTkSwitch(
            master=frame,
            text="Pause",
            variable=self.pause_switch_var,
            onvalue=True,
            offvalue=False,
            command=self.toggle_pause,
            width=80,
        )
        self.pause_switch_widget.grid(row=0, column=6, padx=(0, 5), pady=(15, 0))

        # training button
        self.training_button = components.button(
            frame, 0, 7, "Start Training", self.start_training, padx=(5, 20), pady=(15, 0)
        )
    ...
    def content_frame(self, master):
        ...
        self.sangoi_tab = self.create_sangoi_tab(self.tabview.add("sangoi"))
    ...
    def create_general_tab(self, master):
        ...
        components.path_entry(frame, 0, 1, self.ui_state, "workspace_dir", mode="dir")
    ...
    def create_data_tab(self, master):
        ...
        components.label(
            ...
            1,
            0,
            "Aspect Bucket Quantization Override",
            tooltip="Aspect bucketing quantization override. Set 0 to use the model default.",
        )
        components.entry(frame, 1, 1, self.ui_state, "aspect_bucketing_quantization_override", required=True)
    ...
    def create_sangoi_tab(self, master) -> SangoiTab:
        return SangoiTab(master, self.train_config, self.ui_state)
    ...
    def toggle_pause(self):
        ...
        if self.pause_switch_var.get():
            ...
            if not self.training_commands.request_resume():

...
class TrainUI(ctk.CTk):
    ...
    def create_data_tab(self, master):
        ...
        # latent caching
        components.label(frame, 1, 0, "Bucket Ratio",
                         tooltip="Aspect bucketing quantization.")
        components.entry(frame, 1, 1, self.ui_state, "bucket_ratio", required=True)

        # latent caching
        components.label(frame, 2, 0, "Latent Caching",
        ...
        components.label(frame, 3, 0, "Save Predictions",
                         tooltip="Save prediction tensors for debugging.")

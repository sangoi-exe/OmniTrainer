...
def create_optimizer(
    ...
    if optimizer_config.optimizer == Optimizer.PRODIGY and optimizer_config.fused_back_pass:
        raise ValueError(
            'plain Prodigy does not support "fused_back_pass"; use a supported optimizer or disable fused back pass'
        )
...
def create_lr_scheduler(
    ...
    match learning_rate_scheduler:
        ...
        case LearningRateScheduler.PARABOLIC:
            lr_lambda = lr_lambda_parabolic(scheduler_steps, num_cycles, min_factor)

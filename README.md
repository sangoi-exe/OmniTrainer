...
-   **Supported models**: Ernie Image, Z-Image, Qwen Image, Lumina 2, FLUX.1, Flux.2 Dev and Klein, Chroma, Stable Diffusion 1.5, 2.0, 2.1, 3.0, 3.5, SDXL, Würstchen-v2, Stable Cascade,
...
For a technically focused quick start, see the [Quick Start Guide](docs/QuickStartGuide.md), the [Lumina 2 training notes](docs/LuminaTraining.md), and the [Overview documentation](docs/Overview.md). Otherwise visit [our wiki!](https://github.com/Nerogar/OneTrainer)
